...
class pagination extends CI_Controller {
    ...
    public function insert()
    {
        ...
        $this->form_validation->set_rules('name','Nama Buku','required|trim');
    ...
    public function update($id)
    {
        ...
        $data['tbl_books'] = $this->db->get_where('tbl_books',array('id'=>$id),1)->result_array()[0];
