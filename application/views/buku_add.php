...
<form class="form-horizontal" method="post" action="<?php echo base_url('index.php/pagination/insert') ?>">
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="name" name="name" placeholder="Nama Buku">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="isbn" name="isbn" placeholder="ISBN-13: 978-1491918xxx">
    </div>
  </div>
  <div class="form-group">
